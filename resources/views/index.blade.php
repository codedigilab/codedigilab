...
<body>
    ...
    <main class="main position-relative overflow-hidden" id="mains">
                ...
                <div class="row g-5">
                    <div class="hero-v1-content position-relative">
                        <div class="d-flex align-items-sm-center align-items-end justify-content-between">
                            <h1 class="white-clr text-uppercase khalidtext">
                        ...
                        <div class="hero-sponsor" style="visibility: hidden;">
                            <div class="sponsor-inner d-flex align-items-center ">
        ...
        <section class="about-product pt-4 mt-6">
            <div class="container">
                <div class="row g-xxl-7 g-5">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="about-product-thumb w-100" data-aos="zoom-in" data-aos-duration="2000">
                            <img src="assets/img/my/laptop-design1.webp" alt="img" class="w-100">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="about-product pt-4 mt-6">
            <div class="container">
                <div class="row g-xxl-7 g-5">
                    <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="about-product-thumb w-100" data-aos="zoom-in" data-aos-duration="2000">
                            <img src="assets/img/my/device.webp" alt="img" class="w-100">
                        </div>
                    </div>
                    <div class="col-lg-1">
        ...
        <!-- Product That End -->
        <!-- About v02 Start -->
        <section class="about-product mt-6">
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about-product-content about-content-v02 ps-xxl-10">
                            <div class="pricing-title">
                                ...
                                <h2 class=" mb-xxl-8 mb-xl-7 mb-xl-5 mb-4" data-aos="fade-up" data-aos-duration="1600">
                                ...
                                <div class="d-flex flex-sm-nowrap flex-wrap align-items-center gap-xxl-10 gap-7 gap-md-5 gap-4 mb-xxl-11 mb-xl-10 mb-lg-9 mb-md-7 mb-6"
                                    ...
                                    <p>
                                        Transform your business landscape with our integrated IT and digital marketing
                                        services. From strategic planning to precise execution, we guarantee success in
                                        every sector we engage. Enhance your brand's digital footprint and achieve
        ...
        <!-- khalid v02 End -->
        <!-- Offer Start -->
        <section class="offer-sectionv02 mt-6 mb-6">
        ...
        <section class="project-count mt-4">
            <div class="container">
                <div class="swiper study-slidewrappp row g-xxl-7 g-5 justify-content-center">
                    <div class="swiper-wrapper">
        ...
        <!-- Watch Version01 End -->
        <!-- Step Working Start -->
        <section class="working-sectionv04 mt-6 pb-space position-relative">
            <div class="container">
                    ...
                    <div class="col-lg-5">
                        <div class="text-box position-relative">
                            <p>
                                ...
                                Get the full potential of your business in the digital landscape with our cutting-edge
        ...
        <!-- Text SLider Start -->
        <div class="digital-solution home-onetext mb-xxl-5">
            <div class="mycustom-marque">
                <div class="scrolling-wrap">
                    <div class="comm">
