                     ...
                     <div class="navbar-toggle-item">
                         <ul
                             ...
                             <li class="menu-item position-relative">
                                 ...
                                 <ul style="border-radius: 10px;" class="sub-menu px-lg-4 py-xxl-3 py-2">
                                     <li class="menu-link py-1">
                                         <a href="service" wire:navigate class="fw_500 white-clr">All Service</a>
                                     </li>
                                     <li class="menu-link py-1">
                                         <a href="ecommerce" wire:navigate class="fw_500 white-clr">E-Commerce</a>
                                     </li>
                                 </ul>
                             </li>
                             ...
                             <li class="menu-item position-relative">
                                 ...
                                 <ul style="border-radius: 10px;" class="sub-menu px-lg-4 py-xxl-3 py-2">
                                     <li class="menu-link py-1">
                                         <a href="projects" wire:navigate class="fw_500 white-clr">Project Complete</a>
                                     </li>
                                     <li class="menu-link py-1">
                                         <a href="about" wire:navigate class="fw_500 white-clr">About Us</a>
                                     </li>
                                     <li class="menu-link py-1">
                                         <a href="faq" wire:navigate class="fw_500 white-clr">Faq List</a>
                                     </li>
                                     <li class="menu-link py-1">
                                         <a href="blog" wire:navigate class="fw_500 white-clr">Blog</a>
                                     </li>
                                 </ul>
                             </li>
